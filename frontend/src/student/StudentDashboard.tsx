        ...
        <>
          ...
          <section className="flex flex-col gap-3">
            ...
            {classes === null ? (
              ...
              >
                None of your teachers are running a lesson right now. Live
                lessons show up here as soon as they start.
              </p>
            ) : (
          ...
          <section className="flex flex-col gap-3">
            ...
            {classes === null ? (
              ...
              <p
                className={`m-0 px-5 py-6 text-center text-sm text-muted ${CARD}`}
              >
                When a teacher invites you to a class, the invitation appears at
                ...
                {classes.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        {Array.from({
                          length: Math.min(item.lessonCount, 20),
                        }).map((_, i) => (
                          <span
                            key={i}
