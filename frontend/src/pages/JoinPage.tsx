      ...
      <section className="hero">
        ...
        <div className="hero-art" aria-label="A preview of students learning to code together">
          ...
          <div className="code-window">
            <div className="window-top"><div className="window-lights"><i/><i/><i/></div><span>first_project.py</span><span className="window-live"><i/> PYTHON</span></div>
            <div className="code-body"><div className="line-numbers">01<br/>02<br/>03<br/>04<br/>05<br/>06</div><div className="code-lines"><div><span className="code-purple">def</span> <span className="code-yellow">make_it_real</span>():</div><div className="indent"><span className="code-purple">idea</span> = <span className="code-green">"anything"</span></div><div className="indent"><span className="code-purple">return</span> <span className="code-blue">idea</span>.<span className="code-pink">create</span>()</div><div className="code-gap"/><div><span className="code-yellow">make_it_real</span>() <span className="cursor"/></div><div className="code-comment"># ready to explore</div></div></div>
            <div className="window-footer"><span><i className="success-dot"/> Ready to run</span><span>Python <b>⌄</b></span></div>
          </div>
