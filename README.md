...
3. Enable Google under Supabase Authentication and configure its callback URL as `https://<project-ref>.supabase.co/auth/v1/callback`. For local development, set the site URL to `http://localhost:5173` and add `http://localhost:5173/**` to the redirect URLs.
